...
static BoxDecoration get fillLightBlue => BoxDecoration( color: appTheme.lightBlue40019,);
...
static BoxDecoration get neutral300 => BoxDecoration( color: appTheme.gray300,
);
...
color: appTheme.gray400, width: 1.h,
...
Others decorations
static BoxDecoration get othersWhite => BoxDecoration( color: appTheme.whiteA700,
);
/ Outline decorations
static BoxDecoration get outlineGray => BoxDecoration( color: theme.colorScheme.primary,
);
border: Border.all(
color: appTheme.gray90001,
width: 1.h,
strokeAlign: BorderSide.strokeAlignOutside,
static BoxDecoration get outlineGray300 => BoxDecoration( color: appTheme.gray300,
border: Border(
top: BorderSide(
...
color: appTheme.gray300,
width: 1.h,
static BoxDecoration get outlinePrimary => BoxDecoration( color: theme.colorScheme.primary,
boxShadow: [
BoxShadow(
color: theme.colorscheme.primary.withValues(
),
...
10.h, );
// Custom borders
static BorderRadius get customBorderTL24 => BorderRadius.horizontal( left: Radius.circular(24.h),
);
static BorderRadius get customBorderTL32 => BorderRadius.vertical( top: Radius.circular(32.h),
);
// Rounded borders
