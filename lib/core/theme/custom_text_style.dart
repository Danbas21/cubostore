...
TextStyle get bodyLargePrimaryContainer => theme.textTheme.bodyLarge!.copyWith(
...
TextStyle get bodySmallPrimaryContainer => theme.textTheme.bodySmall!.copyWith(
      color: theme.colorScheme.primaryContainer,
    );
// Headline text style
TextStyle get headlineLargeWhiteA700 => theme.textTheme.headlineLarge!.copyWith(
      color: appTheme.whiteA700,
    );
get headlineSmallUrbanist => theme.textTheme.headlineSmall!.urbanist;
TextStyle get headlineSmallWhiteA700 => theme.textTheme.headlineSmall!.copyWith(
      color: appTheme.whiteA700,
    );
// Label text style
...
TextStyle get labelLargePrimarySemiBold => theme.textTheme.labelLarge!.copyWith(
      color: theme.colorScheme.primary,
      fontWeight: FontWeight.w600,
    );
...
TextStyle get titleMediumLightblueA700 => theme.textTheme.titleMedium!.copyWith(
      color: appTheme.lightBlueA700,
      fontWeight: FontWeight.w500,
    );
...
TextStyle get titleMediumPrimaryBold18 => theme.textTheme.titleMedium!.copyWith(
      color: theme.colorScheme.primary,
      fontSize: 18.fSize,
      fontWeight: FontWeight.w700,
    );
...
TextStyle get titleMediumPrimaryMedium => theme.textTheme.titleMedium!.copyWith(
      color: theme.colorScheme.primary,
      fontWeight: FontWeight.w500,
    );
...
TextStyle get titleSmallDeeporangeA700 => theme.textTheme.titleSmall!.copyWith(
      color: appTheme.deepOrangeA700,
      fontWeight: FontWeight.w600,
    );
...
TextStyle get titleSmallGray50SemiBold => theme.textTheme.titleSmall!.copyWith(
      color: appTheme.gray50,
      fontWeight: FontWeight.w600,
    );
